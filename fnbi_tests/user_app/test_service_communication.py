...
def test_app_service_connection(fnbi_app, fnbi_service):
    ...
    assert "Connected" in fnbi_app.get_status(), "FNBI app failed to connect to the service"
...
def test_app_service_reconnection(fnbi_app, fnbi_service):
    ...
    assert "Connected" in fnbi_app.get_status(), "FNBI app failed to reconnect to the service"
